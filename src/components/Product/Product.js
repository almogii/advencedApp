 ...
 import React from "react";
    ...
    const Product=(props)=>{
        ...
        function catchClickedItems(){
            ...
            if(items==null)
            return;
            items[props.index].amountOfClicks+=1;
            // console.log('itemsArray',items[props.index]);
     ...
     return (
        ...
        <button onClick={catchClickedItems} className='product-add-btn'>add item to cart</button>
        </div>
